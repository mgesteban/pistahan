...
// guides, "/volunteer-appreciation" (aliases: /appreciation, /rsvp) the
// appreciation-night RSVP, everything else is the station scanner. A bare browser visit to
...
export default function App() {
  ...
  if (
    path.startsWith('/volunteer-appreciation') ||
    path.startsWith('/appreciation') ||
