# Pistahan 33 — Volunteer Check-In: How To

*33rd Annual Pistahan Parade & Festival · August 8–9, 2026 · San Francisco*
...
- **Phone dead or no pass?** Just give the scanner your last name — it takes
  about 10 seconds.
- **Camera can't read the QR?** Read out the short code printed under it
  (like `PST-4K7Q`) and they'll type it in.
- **Not on the list?** Go to the **help desk** (separate from the lanes) —
  they'll get you sorted and keep the lines moving.

Salamat for volunteering! 🇵🇭
